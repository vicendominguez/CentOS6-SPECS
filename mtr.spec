...
Packager: Vicente Dominguez <twitter:@vicendominguez>
...
into one program. This is a terminal only tool.
...
%changelog
* Wed Jun 04 2014 Vicente Dominguez <twitter:@vicendominguez> - 2:0.85-1noX
- Updated to release 0.85 without X 
