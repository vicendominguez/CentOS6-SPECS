...
Summary: High performance web server. Yaoweibin No_buffer Patch Applied.
Name: nginx
Version: 1.7.6
Release: 3%{?dist}.ngx.nbp
Vendor: nginx inc.
URL: http://nginx.org/
...
Patch0: nginx-1.7.6-no_buffer-v9.patch
...
a mail proxy server. Yaoweibin no_buffer patch applied.
...
%changelog
* Thu Jan 10 2015 Vicente Dominguez <twitter:@vicentedomiguez>
- 1.7.6-3 yaoweibin no_buffer patch version + fancyindex

* Thu Oct 02 2014 Vicente Dominguez <twitter:@vicentedomiguez>
- 1.7.6-2 yaoweibin no_buffer patch version
